    ...
    return <footer className={Styles["footer"]}>
        <div className={Styles["footer__top"]}>
            <div className={Styles["footer__navigation"]}>
                <h6 className={Styles["footer__navigation-title"]}>Link</h6>
                <h6 className={Styles["footer__navigation-title"]}>Миссия</h6>
                <h6 className={Styles["footer__navigation-title"]}>Ресурсы</h6>
                <h6 className={Styles["footer__navigation-title"]}>О нас</h6>
                <a href="" className={Styles["footer__navigation-link"]}>Преимущества</a>
                <a href="" className={Styles["footer__navigation-link"]}>Повествование</a>
                <a href="" className={Styles["footer__navigation-link"]}>Для инвесторов</a>
                <a href="" className={Styles["footer__navigation-link"]}>История компании</a>
                <a href="" className={Styles["footer__navigation-link"]}>Продукт</a>
                <a href="" className={Styles["footer__navigation-link"]}>Роадмеп</a>
                <a href="" className={Styles["footer__navigation-link"]}>Вайтлист</a>
                <a href="" className={Styles["footer__navigation-link"]}>Об основателе</a>
                <a href="" className={Styles["footer__navigation-link"]}>Галерея</a>
                <a href="" className={Styles["footer__navigation-link"]}>Релизы</a>
                <a href="" className={Styles["footer__navigation-link"]}>Прайслист</a>
                <a href="" className={Styles["footer__navigation-link"]}>Наша команда</a>
                <a href="" className={Styles["footer__navigation-link"]}>Партнеры</a>
                <a href="" className={Styles["footer__navigation-link"]}>Календарь</a>
                <a href="" className={Styles["footer__navigation-link"]}>Презентация</a>
                <a href="" className={Styles["footer__navigation-link"]}>Вакансии</a>
                <a href="" className={Styles["footer__navigation-link"]}>Отзывы</a>
                <a href="" className={Styles["footer__navigation-link"]}>Сторибук</a>
                <a href="" className={`${Styles["footer__navigation-link"]} ${Styles["footer__link-special"]}`}>Файлы</a>
                <a href="" className={Styles["footer__navigation-link"]}>Заявка</a>
                <a href="" className={Styles["footer__navigation-link"]}>Художка</a>
            </div>
